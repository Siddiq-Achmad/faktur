  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.08]">
        <div className="absolute h-px w-full bg-gradient-to-r from-transparent via-primary to-transparent top-1/4 rotate-12" />
        <div className="absolute h-px w-full bg-gradient-to-r from-transparent via-accent to-transparent top-2/4 -rotate-12" />
        <div className="absolute h-px w-full bg-gradient-to-r from-transparent via-secondary to-transparent top-3/4 rotate-6" />
      </div>

      {/* Corner Accent - MORE VISIBLE */}
      <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-primary/10 to-transparent" />
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-gradient-to-tl from-accent/10 to-transparent" />
    </div>
  );
}
